...
function createGroupName(data: RawPropertyDataTypes, groupByColumns: string[], groupByPriceRange: string[]){
...
function mutateTargetGroup(data: RawPropertyDataTypes, targetGroup:GroupByDataTypes){
